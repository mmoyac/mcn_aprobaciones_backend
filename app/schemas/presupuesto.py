...
class PresupuestoDetalle(PresupuestoBase):
    ...
    pre_vb: int = Field(0, description="VB Gerente Operaciones (1=aprobado)")
    pre_VbUsu: Optional[str] = Field(None, description="Usuario VB Gerente Operaciones")
    pre_VbFec: Optional[date] = Field(None, description="Fecha VB Gerente Operaciones")
